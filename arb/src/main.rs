...
enum SubCommand {
    ...
    #[command(
        name = "update",
        about = "Download the latest Arb release (use --apply to install)"
    )]
    Update(update::UpdateCommand),

    #[command(name = "config", about = "Open and edit user arb.lua configuration")]
    Config(config_cmd::ConfigCommand),

    #[command(name = "init", about = "Initialize Arb shell integration")]
