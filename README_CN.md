...
每个终端都说自己"快"和"可定制"。但你花了多少时间安装插件、配置提示符、调主题 -- 只为了得到一个能用的 Shell？arb 把一切内置，跳过配置，直接开始编码。
...
> 如果 arb 帮你省了配置时间，[**来 GitHub 点个 Star**](https://github.com/szj2ys/arb) -- 让更多人发现这个项目。

---

## 开发者评价

> *"从 iTerm2 + oh-my-zsh 切换过来，新 MacBook 上省了 2 小时配置时间。"*

> *"Claude Code 最佳终端 -- 零配置，分屏快，开箱即用。"*

> *"终于有个终端不需要 dotfile 管理博士学位了。"*

> *"从 Warp 换过来，因为我想要开源的、不需要登录的终端。"*
